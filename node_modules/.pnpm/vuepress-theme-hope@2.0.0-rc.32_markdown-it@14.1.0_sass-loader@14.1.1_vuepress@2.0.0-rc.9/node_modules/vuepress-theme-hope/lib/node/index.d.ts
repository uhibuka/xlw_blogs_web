...
/** @private */
declare const getBlogPlugin: (app: App, themeData: ThemeData, options?: BlogOptions | boolean, hotReload?: boolean) => Plugin | null;
 ...
 */
declare const getComponentsPlugin: (options: Pick<ThemeOptions, "hostname" | "hotReload" | "iconAssets" | "iconPrefix">, { components, componentOptions, rootComponents, }?: ComponentOptions, legacy?: boolean) => Plugin;
 ...
 * Get theme plugins
 */
declare const getPluginConfig: (app: App, plugins: PluginsOptions, themeData: ThemeData, options: Pick<ThemeOptions, "hostname" | "hotReload" | "iconAssets" | "iconPrefix" | "favicon">, legacy?: boolean) => PluginConfig;
